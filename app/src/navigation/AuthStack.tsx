...
export default function AuthStack() {
  return (
    <Stack.Navigator initialRouteName="auth:login">
      ...
      <Stack.Screen name="auth:signup" component={SignUpScreen} options={{headerShown: false}} />
      <Stack.Screen name="auth:resetPassword" component={ForgotPasswordScreen} options={{headerShown: false}} />
    </Stack.Navigator>
  );
}
...
export type AuthRootScreenProps = NativeStackScreenProps<AuthRootStackParamList, 'auth:login'>;
